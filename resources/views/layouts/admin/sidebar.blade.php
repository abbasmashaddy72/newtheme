<aside x-data="{ open: false }" x-bind:class="open ? 'sidebar sidebar-mini' : 'sidebar'"
    ...
    <div class="relative flex items-center justify-start border-b dark:border-gray-700">
        <a href="{{ route('dashboard') }}" class="flex px-5 py-4 mr-4 text-xl rtl:ml-4 rtl:mr-0 whitespace-nowraps ">
    ...
    <div class="sidebar-body data-scrollbar">
        <ul class="iq-main-menu dark:bg-dark-card" x-data="sidebar">
            ...
            <x-nav-link :href="route('homepage.edit')" :active="request()->routeIs('homepage.edit*')">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <x-slot name="nav_title">{{ __('HomePage Edit') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('admin.terms')" :active="request()->routeIs('admin.terms*')">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <x-slot name="nav_title">{{ __('Terms') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('admin.privacy')" :active="request()->routeIs('admin.privacy*')">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <x-slot name="nav_title">{{ __('Privacy') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('count.add.edit')" :active="request()->routeIs('count.add.edit*')">
                ...
                <x-slot name="nav_title">{{ __('Count Add Edit') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('service.index')" :active="request()->routeIs('service*')">
                ...
                <x-slot name="nav_title">{{ __('Service') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('blog.index')" :active="request()->routeIs('blog*')">
                ...
                <x-slot name="nav_title">{{ __('Blog') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('review.index')" :active="request()->routeIs('review*')">
                ...
                <x-slot name="nav_title">{{ __('Review') }}</x-slot>
            </x-nav-link>
        </ul>
    </div>
