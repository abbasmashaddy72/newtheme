<aside x-data="{ open: false }" x-bind:class="open ? 'sidebar sidebar-mini' : 'sidebar'"
    ...
    <div class="sidebar-body data-scrollbar">
        <ul class="iq-main-menu dark:bg-dark-card" x-data="sidebar">
            ...
            <x-nav-link :href="route('booked.appointment')" :active="request()->routeIs('booked.appointment')">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <x-slot name="nav_title">{{ __('Booked Appointment') }}</x-slot>
            </x-nav-link>
            <x-nav-link :href="route('contacted.us')" :active="request()->routeIs('contacted.us')">
                <i class="icon">
                    <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                            d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                ...
                <x-slot name="nav_title">{{ __('Contacted Us') }}</x-slot>
            </x-nav-link>
            ...
            <x-nav-link :href="route('keywords')" :active="request()->routeIs('keywords*')">
                ...
                <x-slot name="nav_title">{{ __('Keywords & SiteMap') }}</x-slot>
            </x-nav-link>
        </ul>
    </div>
