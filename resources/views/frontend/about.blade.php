        ...
        <div class="max-w-6xl px-4 pt-16 mx-auto sm:px-6">
            <div class="pt-6 pb-12 md:pt-8 md:pb-20">
                ...
                <div class="max-w-3xl pb-12 mx-auto text-center md:pb-20">
                    <h2 class="mb-4 h2 font-red-hat-display">We help teams by delivering the perfect tools</h2>
                    <p class="text-xl text-gray-600 dark:text-gray-400">Excepteur sint occaecat cupidatat non proident, sunt
                ...
                <div
                    ...
                    <div class="relative flex flex-col items-center">
                        ...
                        <div class="relative w-20 h-20 mb-3">
                            ...
                            <svg class="w-20 h-20 text-teal-500 fill-current" viewBox="0 0 80 80"
                        ...
                        <div class="font-medium sm:text-lg dark:text-gray-300">Founded in 2017</div>
                    </div>
                    ...
                    <div class="relative flex flex-col items-center">
                        ...
                        <div class="relative w-20 h-20 mb-3">
                            <div class="absolute inset-0 rounded-full opacity-30 bg-gradient-to-tr from-purple-500 -z-1"
                                aria-hidden="true"></div>
                            <svg class="w-20 h-20 text-purple-500 fill-current" viewBox="0 0 80 80"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="font-medium sm:text-lg dark:text-gray-300">$20M+ Achieved</div>
                    </div>
                    ...
                    <div class="relative flex flex-col items-center">
                        ...
                        <div class="relative w-20 h-20 mb-3">
                            <div class="absolute inset-0 rounded-full opacity-30 bg-gradient-to-tr from-indigo-500 -z-1"
                                aria-hidden="true"></div>
                            <svg class="w-20 h-20 text-indigo-500 fill-current" viewBox="0 0 80 80"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="font-medium sm:text-lg dark:text-gray-300">10.000+ Websites</div>
                    </div>
                    ...
                    <div class="relative flex flex-col items-center">
                        <div class="relative w-20 h-20 mb-3">
                            <div class="absolute inset-0 rounded-full opacity-30 bg-gradient-to-tr from-pink-500 -z-1"
                                aria-hidden="true"></div>
                            <svg class="w-20 h-20 text-pink-500 fill-current" viewBox="0 0 80 80"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="font-medium sm:text-lg dark:text-gray-300">1M+ Customers</div>
                    </div>
    ...
    <section>
        <div class="max-w-6xl px-4 mx-auto sm:px-6">
            <div class="py-12 border-t border-gray-200 md:py-20 dark:border-gray-800">
                ...
                <!-- Section header -->
                <div class="max-w-3xl pb-12 mx-auto text-center md:pb-20">
                    <h2 class="mb-4 h2 font-red-hat-display">What we’ve achieved</h2>
                    <p class="text-xl text-gray-600 dark:text-gray-400">Excepteur sint occaecat cupidatat non proident, sunt
                        in culpa qui officia
                        deserunt mollit anim id est.</p>
                </div>
                ...
                <div x-data="{ year: '2020' }">
                    <div class="flex items-start">
                        ...
                        <div class="grow" x-show="year === '2016'">
                            <div class="grid gap-6 md:grid-cols-2">
                                <article class="flex flex-col p-6 bg-white shadow-2xl md:col-span-2 dark:bg-gray-800">
                                    <header>
                                        <h3 class="mb-1 h4 font-red-hat-display">
                                            <a href="#0">Mobile builder enabled</a>
                                        </h3>
                                    ...
                                    <div class="text-gray-600 dark:text-gray-400 grow">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                            incididunt. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui
    ...
    <section class="relative border-t border-gray-200 dark:border-gray-800">
        ...
        <div class="relative max-w-6xl px-4 mx-auto sm:px-6">
            <div class="py-12 md:py-20">
                ...
                <!-- Section header -->
                <div class="max-w-3xl pb-12 mx-auto text-center md:pb-20">
                    <h2 class="mb-4 h2 font-red-hat-display">Explore roles at Appy’s offices around the world</h2>
                    <p class="text-xl text-gray-600 dark:text-gray-400">Excepteur sint occaecat cupidatat non proident,
