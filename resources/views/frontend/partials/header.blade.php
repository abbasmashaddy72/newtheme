        ...
        <div class="flex items-center justify-between h-20">
            ...
            <nav class="hidden md:flex md:grow">
                ...
                <div class="flex flex-col justify-center ml-3 form-switch">
                    <input type="checkbox" name="light-switch" id="light-switch-desktop" class="sr-only light-switch" />
            ...
            <div class="inline-flex md:hidden" x-data="{ expanded: false }">
                ...
                <div class="form-switch flex flex-col justify-center mr-6 -mt-0.5">
                    <input type="checkbox" name="light-switch" id="light-switch-mobile" class="sr-only light-switch" />
